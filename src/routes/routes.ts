...
import { createSampleSchema, updateSampleSchema, idParamSchema as sampleIdSchema } from "../schemas/samples.schema.js";
import { createVisitorSchema, updateVisitorSchema, idParamSchema as visitorIdSchema } from "../schemas/visitors.schema.js";
import { createDeliverySchema, idParamSchema as deliveryIdSchema } from "../schemas/deliveries.schema.js";
import { validate } from "../middleware/validate.middleware";
import { createSample, deleteSample, getSample, getSamples, updateSample } from "../controllers/samples.controller.js";
import { createVisitor, deleteVisitor, getVisitor, getVisitors, updateVisitor } from "../controllers/visitor.controller.js";
import { createDelivery, deleteDelivery, getDeliveries, getDelivery, updateDelivery } from "../controllers/delivery.controller.js";

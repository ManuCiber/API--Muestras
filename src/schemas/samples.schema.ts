...
export const createSampleSchema = z.object({
    ...
    umbral_minimo: z.number().int().nonnegative("Umbral minimo must be a non-negative integer")
});
...
export const updateSampleSchema = z.object({
    ...
    umbral_minimo: z.number().int().nonnegative("Umbral minimo must be a non-negative integer").optional()
});
